...
class FourHeatServicesSetup:
    """Class to handle Integration Services."""

    def __init__(self, hass: HomeAssistant, config_entry: ConfigEntry) -> None:
        """Initialise services."""

        _LOGGER.info("Setting up 4Heat services")

        self.hass = hass
        self.config_entry = config_entry
        self.coordinator: FourHeatDataUpdateCoordinator = hass.data[DOMAIN][
    ...
    async def rename_device(self, service_call: ServiceCall) -> None:
        ...
        try:
            ...
            if result:
                ...
                dev_reg.async_update_device(device_entry.id, name=device_name)
